...
const MenuItem = ({ menuItem, changeIsActive }: ProjectMenuItem) => {
  return (
    ...
    >
      <div
        className={cn(
          "flex gap-x-2 py-2 px-5 sm:px-9 sm:mx-4 lg:px-4 rounded-md shadow-lg border border-white bg-white hover:bg-neutral-400 hover:border-neutral-400 cursor-pointer transition",
